...
class AgendaProcesoDisciplinarioBase(BaseModel):
    ...
    EstadoAgenda: Optional[str] = "PROGRAMADO"
...
class AgendaProcesoDisciplinarioCreate(AgendaProcesoDisciplinarioBase):
    pass


class AgendaProcesoDisciplinarioUpdate(BaseModel):
    IdTipoEventoDisciplinario: Optional[int] = None
...
class AgendaProcesoDisciplinarioResponse(AgendaProcesoDisciplinarioBase):
