...
class CierreProcesoDisciplinario(Base):
    ...
    IdCierreProcesoDisciplinario = Column(Integer, primary_key=True, index=True)
    ...
    TipoCierre = Column(String(150), nullable=True)
    MedidaDisciplinaria = Column(String(150), nullable=True)
    ConclusionRRLL = Column(Text, nullable=True)
    ResponsableCierre = Column(String(200), nullable=True)
